...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/assets/fonts/font-awesome-4.2.0/css/font-awesome.min.css" />
  <link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url'); ?>/assets/css/menu_topside.css" />
